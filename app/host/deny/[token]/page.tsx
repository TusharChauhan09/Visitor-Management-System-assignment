...
export default async function HostDenyPage({
  params,
}: {
  ...
  return (
    <PageShell title="Deny visitor?" description="Confirm to reject this visit. Security will be notified at the desk.">
      <HostVisitSummary
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        <HostDecisionForm token={token} action="deny" label="Confirm denial" variant="destructive" />
        <Link
          href={`/host/approve/${token}`}
